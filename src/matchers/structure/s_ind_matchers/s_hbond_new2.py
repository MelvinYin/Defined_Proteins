...
from .hb_components import CategoryComponent, BondDistComponent, TempComponent


# BondDistComponent
class _HbMatcher:
    def __init__(self, components=(TempComponent,)):
...
class HbMatcher:
    ...
    def query(self, df):
        ...
        output = self.matcher.query(hb_datapoint)
        return output
