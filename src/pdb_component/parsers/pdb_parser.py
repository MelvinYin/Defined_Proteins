...
class ATOMSeqParser(BaseParser):
    ...
    def split_line(self, line):
        ...
        :return: Dict[str, str]
        """
        splitted = dict(_record_name=line[:6], ano=line[6:11],
                        aname=line[12:16], _altLoc=line[16], res=line[17:20],
                        cid=line[21], sno=line[22:26], _AChar=line[27],
                        coord=tuple([line[31:38], line[39:46], line[47:54]]),
                        occupancy=line[55:60], tempfactor=line[61:66],
                        elementsymbol=line[77:78], _charge=line[79:80])
    ...
    def check_validity(self, line):
        ...
        assert re.fullmatch("[0-9]+", line["ano"]) and line["ano"] != "0"
